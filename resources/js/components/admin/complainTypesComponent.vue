                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            <select v-model="queryFiled" class="form-control" id="fileds">
                                                <option value="title">Complain Type Title </option>
                                                <option value="about">Details</option>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover">
                                ...
                                >
                                    ...
                                    <td style="max-width:400px">{{ singleRow.name }}<br>id:{{ singleRow.id }}</td>
        ...
        >
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <strong>Complain Type Title : {{ form.name }}</strong>
                        <br>
                        <strong>Complain Type Details : {{ form.details }}</strong>
                        <br>
...
export default {
    ...
    data() {
        return {
            ...
            getDataUrl: "/api/complain_type_list?page=",
            addFormUlr: "api/complain_type_list",
            updateFormUlr: "api/complain_type_update/",
            deleteFormUlr: "api/complain_type_delete/",
            searchUrl: "api/complain_type_search/",
            pageTitle: 'Complain Type',
            formTitle: 'Complain Type',
            nameFieldTitle: 'Complain Type Title',
            detailsFieldTitle: 'Complain Type Details',
            showPageTitle: "Complain Type Details",
            editMode: false,
            dataRows: [],
            query: "",
            queryFiled: "title",
            ...
            form: new Form({
                id: "",
                name: "Complain Type title",
                details: "Complain Type details ",
