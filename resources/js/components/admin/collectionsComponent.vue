                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            <select v-model="queryFiled" class="form-control" id="fileds">
                                                ...
                                                <option value="date">collected Date</option>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover">
                                ...
                                >
                                    ...
                                    <td style="max-width:400px">{{ singleRow.collected_date }}</td>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input
                                    ...
                                    name="collected_date"
                                    class="form-control"
                                    :class="{ 'is-invalid': form.errors.has('collected_date') }"
                                >
                                <has-error :form="form" field="collected_date"></has-error>
                            </div>
                            <div class="form-group">
        ...
        >
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <strong>Collection Title : {{ form.name }}</strong>
                        <br>
                        <strong>Collection Details : {{ form.details }}</strong>
                        <br>
                        <strong>Collected date : {{ form.collected_date }}</strong>
                        <br>
...
export default {
    ...
    data() {
        return {
            ...
            showPageTitle: "Collection Details",
            getDataUrl: "/api/collection_list?page=",
            addFormUlr: "api/collection_list",
            updateFormUlr: "api/collection_update/",
            deleteFormUlr: "api/collection_delete/",
            searchUrl: "api/collection_search/",
            pageTitle: 'Collection List',
            formTitle: 'Collection',
            nameFieldTitle: 'Collection Title',
            detailsFieldTitle: 'Collection Details',
            editMode: false,
            dataRows: [],
            query: "",
            queryFiled: "title",
