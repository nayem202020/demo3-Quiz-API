                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            <select v-model="queryFiled" class="form-control" id="fileds">
                                                <option value="title">Mode title </option>
        ...
        >
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <strong>Mod title : {{ form.name }}</strong>
                        <br>
...
export default {
    ...
    data() {
        return {
            ...
            showPageTitle: "Mod Details",
            getDataUrl: "/api/mode_list?page=",
            addFormUlr: "api/mode_list",
            updateFormUlr: "api/mode_update/",
            deleteFormUlr: "api/mode_delete/",
            searchUrl: "api/mode_search/",
            pageTitle: 'Mod List',
            formTitle: 'Mod',
            nameFieldTitle: 'Mode Title',
