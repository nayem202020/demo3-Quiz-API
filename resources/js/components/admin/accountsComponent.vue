                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover">
                                ...
                                >
                                    ...
                                    <td class='text-success' :class="{ 'text-danger':singleRow.locke_status == 0 }" >{{ singleRow.locke_status==0?'Inactive':'Active'  }}</td>
        ...
        >
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <strong>Account Name : {{ form.name }}</strong>
                        <br>
...
export default {
    ...
    data() {
        return {
            snotifyDeleteSuccessMsg: "Account Successfully Deleted",
            snotifySuccess: "Account Successfully Updated",
            snotifyTitle: "Success",
            showPageTitle: "Account Details",
            getDataUrl: "/api/account_list?page=",
            addFormUlr: "api/account_list",
            updateFormUlr: "api/account_update/",
            deleteFormUlr: "api/account_delete/",
            searchUrl: "api/account_search/",
            ...
            query: "",
            queryFiled: "name",
            reloadeDefaultQueryField: "name",
            pagination: {
                current_page: 1,
            },
            form: new Form({
                id: "",
                name: "Example Bank Limited 12783 00 674",
            ...
            this.form
                ...
                .then(response => {
                    ...
                    if (this.form.successful) {
                        this.$Progress.finish();
                        this.$snotify.success(this.snotifySuccess, this.snotifyTitle);
                    } else {
                        this.$Progress.fail();
                        this.$snotify.error(
