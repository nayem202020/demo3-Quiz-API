        ...
        >
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <strong>Note title : {{ form.name }}</strong>
                        <br>
...
export default {
    ...
    data() {
        return {
            ...
            showPageTitle: "Note Details",
            getDataUrl: "/api/note_list?page=",
            addFormUlr: "api/note_list",
            updateFormUlr: "api/note_update/",
            deleteFormUlr: "api/note_delete/",
            searchUrl: "api/note_search/",
            pageTitle: 'Note List',
            formTitle: 'Note',
            nameFieldTitle: 'Note Title',
            detailsFieldTitle: '',
            editMode: false,
            dataRows: [],
            query: "",
