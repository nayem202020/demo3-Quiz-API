                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover">
                                ...
                                >
                                    ...
                                    <td style="max-width:400px">{{ singleRow.bank_details }}</td>
        ...
        >
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <strong>Bank Name : {{ form.name }}</strong>
                        <br>
                        <strong>Bank Details : {{ form.bank_details }}</strong>
                        <br>
...
export default {
    ...
    data() {
        return {
            ...
            snotifySuccess: "Bank Successfully Updated",
            snotifyTitle: "Success",
            showPageTitle: "Bank Details",
            getDataUrl: "/api/bank_list?page=",
            addFormUlr: "api/bank_list",
            updateFormUlr: "api/bank_update/",
            deleteFormUlr: "api/bank_delete/",
            searchUrl: "api/bank_search/",
            pageTitle: 'Bank List',
            formTitle: 'Bank',
            nameFieldTitle: 'Bank Name',
            detailsFieldTitle: 'Bank Details',
            editMode: false,
            dataRows: [],
            query: "",
            queryFiled: "name",
