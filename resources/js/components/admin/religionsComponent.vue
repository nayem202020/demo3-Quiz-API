                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            <select v-model="queryFiled" class="form-control" id="fileds">
                                                <option value="name">Religion name </option>
        ...
        >
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <strong>Religion Name : {{ form.name }}</strong>
                        <br>
                        <strong>Religion Details : {{ form.details }}</strong>
                        <br>
...
export default {
    ...
    data() {
        return {
            ...
            showPageTitle: "Religion Details",
            getDataUrl: "/api/religion_list?page=",
            addFormUlr: "api/religion_list",
            updateFormUlr: "api/religion_update/",
            deleteFormUlr: "api/religion_delete/",
            searchUrl: "api/religion_search/",
            pageTitle: 'Religion List',
            formTitle: 'Religion',
            nameFieldTitle: 'Religion Name',
            detailsFieldTitle: 'Religion Details',
            editMode: false,
            dataRows: [],
            query: "",
            queryFiled: "name",
