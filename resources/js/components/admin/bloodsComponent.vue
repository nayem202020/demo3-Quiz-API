                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            <select v-model="queryFiled" class="form-control" id="fileds">
                                                <option value="title">Blood Group </option>
        ...
        >
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <strong>Blood Name : {{ form.name }}</strong>
                        <br>
                        <strong>Blood Details : {{ form.details }}</strong>
                        <br>
...
export default {
    ...
    data() {
        return {
            ...
            showPageTitle: "Blood Details",
            getDataUrl: "/api/blood_list?page=",
            addFormUlr: "api/blood_list",
            updateFormUlr: "api/blood_update/",
            deleteFormUlr: "api/blood_delete/",
            searchUrl: "api/blood_search/",
            pageTitle: 'Blood List',
            formTitle: 'Blood',
            nameFieldTitle: 'Blood Title',
            detailsFieldTitle: 'Blood Details',
            editMode: false,
            dataRows: [],
            query: "",
            queryFiled: "title",
