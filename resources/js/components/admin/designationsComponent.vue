                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            <select v-model="queryFiled" class="form-control" id="fileds">
                                                <option value="title">Designation Title </option>
        ...
        >
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <strong>Designation Title : {{ form.name }}</strong>
                        <br>
                        <strong>Designation Details : {{ form.details }}</strong>
                        <br>
...
export default {
    ...
    data() {
        return {
            ...
            getDataUrl: "/api/designation_list?page=",
            addFormUlr: "api/designation_list",
            updateFormUlr: "api/designation_update/",
            deleteFormUlr: "api/designation_delete/",
            searchUrl: "api/designation_search/",
            pageTitle: 'Designation List',
            formTitle: 'Designation',
            nameFieldTitle: 'Designation Title',
            detailsFieldTitle: 'Designation Details',
            showPageTitle: "Designation Details",
            editMode: false,
            dataRows: [],
            query: "",
            queryFiled: "title",
