                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            <select v-model="queryFiled" class="form-control" id="fileds">
                                                <option value="title">Expense Type Title </option>
        ...
        >
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <strong>Expense type title : {{ form.name }}</strong>
                        <br>
                        <strong>Expense type Details : {{ form.details }}</strong>
                        <br>
...
export default {
    ...
    data() {
        return {
            ...
            showPageTitle: "Expense Type Details",
            getDataUrl: "/api/expense_type_list?page=",
            addFormUlr: "api/expense_type_list",
            updateFormUlr: "api/expense_type_update/",
            deleteFormUlr: "api/expense_type_delete/",
            searchUrl: "api/expense_type_search/",
            pageTitle: 'Expense Type List',
            formTitle: 'Expense Type',
            nameFieldTitle: 'Expense Type Title',
            detailsFieldTitle: 'Expense Type Details',
            editMode: false,
            dataRows: [],
            query: "",
            queryFiled: "title",
            ...
            form: new Form({
                id: "",
                name: "Liflet printing",
                details: "Liflet printing details ",
